...
def upload_product_with_excel(request):
    ...
    return render(request, "staff/upload_form.html", context)
...
#             Product, "xls", file_name="sheet"
#         )
#     # elif atype == "book":
#     #     return excel.make_response_from_tables(
#     #         [Product, ProductItem], "xls", file_name="book"
#     #     )
#     # elif atype == "custom":
#     #     product = Product.objects.get(slug="ide")
...
#         def choice_func(row):
#             q = Product.objects.filter(slug=row[0])[0]
#             row[0] = q
#             return row

#         if form.is_valid():
#             request.FILES["file"].save_book_to_database(
#                 models=[Product, ProductItem],
